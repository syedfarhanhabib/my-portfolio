...
const Card: React.FC<CardProps> = ({ customClass, text, img, link }) => {
  return (
    <>
      <div className={`${customClass} overflow-hidden relative w-full h-full`}>
        ...
        <h1 className={`${neueMachina.className} tracking-tightest text-4xl md:text-7xl text-transparent bg-clip-text bg-gradient-to-br from-light to-depth-dark leading-none mt-2`}>
          {text}
        </h1>
      </div>
    </>
