  ...
  return (
    <>
      <div className={`${customClass} overflow-hidden relative w-full h-full shadow-2xl rounded-3xl`}>
        ...
        <Link href={link}>
          <h1 className={`${neueMachina.className} tracking-tightest text-4xl md:text-7xl text-transparent bg-clip-text bg-gradient-to-br from-light to-depth-dark leading-none absolute left-5 bottom-5`}>
            {text}
          </h1>
        </Link>
      </div>
