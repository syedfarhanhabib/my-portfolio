  ...
  return (
    <>
      <div className={`${customClass} relative w-full h-full`}>
        <Image className='w-full h-full object-cover hover:scale-[1.009] shadow-xl rounded-3xl transition-all duration-300' height={500} width={500} src={img} alt='Project cover' />
        <Link href={link}>
        </Link>
