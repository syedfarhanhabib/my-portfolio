...
export default function Home() {
  return (
    <>
      <div className="hero w-full overflow-hidden min-h-screen bg-light text-dark dark:bg-dark dark:text-light px-10 relative pt-40 flex flex-col justify-between">
      ...
      <div className="projects z-10 w-full min-h-screen p-10 bg-light text-dark dark:bg-dark dark:text-light">
        <TabsSection />
      </div>
      <div className="lampsection w-full min-h-screen">
        <LampSection />
      </div>
      {/* <div className="pin-card w-full min-h-screen">
        <AnimatedPinDemo />
      </div> */}
    </>
  );
