...
function page() {
  return (
    <div className='min-h-screen bg-light text-dark dark:bg-dark dark:text-light px-5 md:px-10 pt-20 md:pt-40 pb-10 '>
      ...
      <div className="cards flex flex-col md:flex-row gap-10 mt-10 ">
        <Card img='/frame.jpg' text='project' customClass='' link='/' />
        <Card img='/Docs.png' text='project' customClass='md:mt-40' link='/' />
      </div>
    </div>
  )
}
